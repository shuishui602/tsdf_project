...
if __name__ == "__main__":
  ...
  label_im = cv2.resize(cv2.imread(os.path.join(root,"label/0.png")), depth_im.shape, interpolation = cv2.INTER_NEAREST).astype(np.int)
  ...
  tsdf_vol.integrate(label_im, depth_im, cam_intr, cam_pose, obs_weight=1.)
  print(time.time()-t0)
